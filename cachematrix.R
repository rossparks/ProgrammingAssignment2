## This function is meant to save time and computing power 
## when computing matricies.  This will compute the inverse
## once and cache the results to avoid having to do it more then once.
...
cacheSolve <- function(x, ...) {
    ...
    # If the value of Inverse is NULL, then you retrive matrix x and calculate the inverse w/solve() function
